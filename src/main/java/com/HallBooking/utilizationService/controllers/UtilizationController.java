...
public class UtilizationController {
	...
	public Optional<OwnerInformation> GetOwerInformation(@PathVariable String adhar, @PathVariable String email,
		@PathVariable String phonenum) {
		return service.GetOwnerInformation(adhar, email, phonenum);
	}
}
